...
pub fn get_transfer_inverse_fee<'data, S: BaseState + solana_program::program_pack::Pack>(
...
pub fn get_transfer_fee<'data, S: BaseState + solana_program::program_pack::Pack>(
    account_state: &StateWithExtensions<'data, S>,
    epoch: u64,
    pre_fee_amount: u64,
) -> u64 {
...
pub fn get_account_extensions<'data, S: BaseState + solana_program::program_pack::Pack>(
    account_state: &StateWithExtensions<'data, S>,
) -> Vec<ExtensionStruct> {
