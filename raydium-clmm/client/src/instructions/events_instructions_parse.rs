...
pub fn handle_program_log(
    ...
    if let Some(log) = if with_prefix {
        ...
        // qtrade:
// Had to switch to new implementation for Discriminator through-out event_instructions_parse.rs.
// Matches on the arms in the match below had to be changed to match arm guards:
//
// val if val == &instruction::CreateAmmConfig::DISCRIMINATOR[..8] => {
//
...
// }
        match disc {
            val if val == &ConfigChangeEvent::DISCRIMINATOR[..8] => {
                println!("{:#?}", decode_event::<ConfigChangeEvent>(&mut slice)?);
            }
            val if val == &CollectPersonalFeeEvent::DISCRIMINATOR[..8] => {
                println!(
                    "{:#?}",
                    decode_event::<CollectPersonalFeeEvent>(&mut slice)?
                );
            }
            val if val == &CollectProtocolFeeEvent::DISCRIMINATOR[..8] => {
                println!(
                    "{:#?}",
                    decode_event::<CollectProtocolFeeEvent>(&mut slice)?
                );
            }
            val if val == &CreatePersonalPositionEvent::DISCRIMINATOR[..8] => {
                println!(
                    "{:#?}",
                    decode_event::<CreatePersonalPositionEvent>(&mut slice)?
                );
            }
            val if val == &DecreaseLiquidityEvent::DISCRIMINATOR[..8] => {
                println!("{:#?}", decode_event::<DecreaseLiquidityEvent>(&mut slice)?);
            }
            val if val == &IncreaseLiquidityEvent::DISCRIMINATOR[..8] => {
                println!("{:#?}", decode_event::<IncreaseLiquidityEvent>(&mut slice)?);
            }
            val if val == &LiquidityCalculateEvent::DISCRIMINATOR[..8] => {
                println!(
                    "{:#?}",
                    decode_event::<LiquidityCalculateEvent>(&mut slice)?
                );
            }
            val if val == &LiquidityChangeEvent::DISCRIMINATOR[..8] => {
            ...
            // }
            val if val == &SwapEvent::DISCRIMINATOR[..8] => {
                println!("{:#?}", decode_event::<SwapEvent>(&mut slice)?);
            }
            val if val == &PoolCreatedEvent::DISCRIMINATOR[..8] => {
...
// }
    match disc {
        ...
        val if val == &instruction::UpdateAmmConfig::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::CreatePool::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::UpdatePoolStatus::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::CreateOperationAccount::DISCRIMINATOR[..8] => {
            let ix =
        ...
        val if val == &instruction::UpdateOperationAccount::DISCRIMINATOR[..8] => {
            let ix =
        ...
        val if val == &instruction::TransferRewardOwner::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::InitializeReward::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::CollectRemainingRewards::DISCRIMINATOR[..8] => {
            let ix =
        ...
        val if val == &instruction::UpdateRewardInfos::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::SetRewardParams::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::CollectProtocolFee::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::CollectFundFee::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::OpenPosition::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::OpenPositionV2::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::ClosePosition::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::IncreaseLiquidity::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::IncreaseLiquidityV2::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::DecreaseLiquidity::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::DecreaseLiquidityV2::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::Swap::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::SwapV2::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::SwapRouterBaseIn::DISCRIMINATOR[..8] => {
