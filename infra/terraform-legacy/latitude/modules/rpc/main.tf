...
resource "latitudesh_server" "qtrade_rpc_node" {
  hostname         = "qtrade_rpc_node"
...
resource "latitudesh_vlan_assignment" "qtrade_rpc_vlan_assignment" {
    server_id          = latitudesh_server.qtrade_rpc_node.id
