...
resource "latitudesh_server" "qtrade_metrics_node" {
  hostname         = "qtrade_metrics_node"
...
resource "latitudesh_vlan_assignment" "qtrade_metrics_vlan_assignment" {
    server_id          = latitudesh_server.qtrade_metrics_node.id
