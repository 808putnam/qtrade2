...
resource "latitudesh_server" "qtrade_vixen_node" {
  hostname         = "qtrade_vixen_node"
...
resource "latitudesh_vlan_assignment" "qtrade_postgres_vlan_assignment" {
    server_id          = latitudesh_server.qtrade_vixen_node.id
