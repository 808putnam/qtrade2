...
impl From<KeyedAccount> for KeyedUiAccount {
    fn from(keyed_account: KeyedAccount) -> Self {
        ...
        // qtrade: function name changed moving to solana_account_decoder 2.1.0
        // let ui_account = UiAccount::encode(&key, &account, UiAccountEncoding::Base64, None, None);
        let ui_account = solana_account_decoder::encode_ui_account(&key, &account, UiAccountEncoding::Base64, None, None);
