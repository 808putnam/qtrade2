...
const QTRADE_STREAMER_TRACER_NAME: &str = "qtrade_streamer";
const QTRADE_STREAMER: &str = "qtrade_steamer";

pub static QTRADE_STREAMER_SCOPE: Lazy<InstrumentationScope> = Lazy::new(|| {
    InstrumentationScope::builder(QTRADE_STREAMER_TRACER_NAME)
        .with_version(env!("CARGO_PKG_VERSION"))
        .with_schema_url("https://opentelemetry.io/schemas/1.17.0")
        .build()
});

pub static QTRADE_STREAMER_METER: Lazy<Meter> = Lazy::new(|| {
    global::meter(QTRADE_STREAMER)
});
