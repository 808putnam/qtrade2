...
// }
        match disc {
            ...
            val if val == &LpChangeEvent::DISCRIMINATOR[..8] => {
...
// }
    match disc {
        ...
        val if val == &instruction::Initialize::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::Deposit::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::Withdraw::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::SwapBaseInput::DISCRIMINATOR[..8] => {
        ...
        val if val == &instruction::SwapBaseOutput::DISCRIMINATOR[..8] => {
