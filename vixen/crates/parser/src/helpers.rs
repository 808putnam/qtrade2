...
// qtrade
// Had to modify the namespacing here as spl_pod from 0.3.0 to 0.5.0 changed the namespacing
// yellowstone_vixen_core::pubkey_convert_helpers!(spl_pod::solana_program::pubkey::Pubkey);
yellowstone_vixen_core::pubkey_convert_helpers!(spl_pod::solana_pubkey::Pubkey);
#[cfg(feature = "proto")]
...
pub mod proto {
    ...
    use spl_pod::solana_program_option::COption;
